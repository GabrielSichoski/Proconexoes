...
export class PagInicialComponent {
  ...
  conteudo3 = new contet("JavaScript", "10 Perguntas")
  ...
  posts:Array<mainPost> = [new mainPost("Yago", "Bem vindo a minhas ferias", "../../assets/paisagem-natural.jpg"),new mainPost("Gabriel", "Texto","../../assets/paisagem-natural.jpg")]
